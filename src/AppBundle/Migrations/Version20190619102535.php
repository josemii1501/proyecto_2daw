 ...
 */
final class Version20190619102535 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE file (id INT AUTO_INCREMENT NOT NULL, video_id INT DEFAULT NULL, file VARCHAR(255) NOT NULL, date DATETIME NOT NULL, INDEX IDX_8C9F361029C1004E (video_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
